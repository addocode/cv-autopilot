...
function html() {
  ...
  const expHtml = cv.experiences.map((experience) => {
    ...
    const titleHtml = experience.id === 'mediamatiker-ausbildung-army-bict'
      ? `<div class="meta experience-title combined-training-title" data-source-ids="${esc((experience.sources || []).join(','))}" data-evidence-status="verified"><span data-ats-required data-ats-text="Mediamatiker EFZ in Ausbildung">Mediamatiker EFZ in Ausbildung</span><span class="combined-training-credential" data-ats-required data-ats-text="Berufsmaturität Typ Wirtschaft und Dienstleistungen">Berufsmaturität Typ Wirtschaft und Dienstleistungen</span></div>`
