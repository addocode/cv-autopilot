...
async function withPlaywright() {
  ...
  const metrics = await page.evaluate(({ bgExists, variantMeta }) => {
    ...
    out.skillsetsQuality.sectionTitle = sectionTitleSample('.competencies-page-title', 'FÄHIGKEITEN UND SKILLS');
